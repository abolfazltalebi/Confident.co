      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We provide comprehensive dental care services to ensure your oral health and beautiful smile.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600">
              Straighten your teeth with modern orthodontic solutions and braces.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Dental Implants</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600">
              24/7 emergency dental care when you need it most.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600">
              Regular checkups and cleanings to maintain optimal oral health.
            </p>
          </div>
        </div>
      </div>
